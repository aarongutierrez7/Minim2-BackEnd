...
public class GameManagerImpl implements GameManager{
    ...
    public List<Insignias> listaInsignias;
    ...
    @Override
    public void addInsignia(String username, String insignia){
    ...
    @Override
    public void createInsignia (String nameInsignia, String fotoURL){
        Insignias insignia = new Insignias(nameInsignia, fotoURL);
        listaInsignias.add(insignia);
    }


   /* @Override
    public void newUser(String name, String username, String avatar) {
        User user = new User(name, username, avatar);
        user.setName("Aaron");
        user.setUsername("aaronguti");
        user.setAvatar("C:\\Users\\Aaron\\Desktop\\ProyectoDSA\\DSA_BackendProject\\public\\espinete.jpg");
        logger.info("Usuario añadido:" + username);
